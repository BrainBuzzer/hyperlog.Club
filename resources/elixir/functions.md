...
We briefly covered guards in the [Control Structures](https://hyperlog.club/resources/elixir/control-structures) lesson, now we'll see how we can apply them to named functions.
