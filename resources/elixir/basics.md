...
After Elixir is installed, you can easily confirm the installed version.
    ...
    % elixir -v
    Erlang/OTP 22.0 [erts-10.4.1] [source] [64-bit] [smp:4:4] [ds:4:4:10] [async-threads:10] [hipe] [kernel-poll:false] [dtrace]
...
We'll learn more about these when we learn about [collections](https://hyperlog.club/resources/elixir/collections/) and [functions](https://hyperlog.club/resources/elixir/functions/).
