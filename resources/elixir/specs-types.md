...
You could use [@doc annotation](https://hyperlog.club/resources/elixir/documentation), but it is only information for other developers that is not checked in compilation time.
...
For more information on `structs`, please reference the section on [modules](https://hyperlog.club/resources/elixir/modules/).
...
As we know from the [documentation](https://hyperlog.club/resources/elixir/documentation) lesson we have `@doc` and `@moduledoc` annotations to create documentation for functions and modules.
