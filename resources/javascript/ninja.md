...
<div class="warn-imp">
<span class="header-imp">Irony detected</span>
<span class="content">
...
When in the darkness, can see everything in the light.<br>
- Guan Yin Zi
</div>
```
...
both to the left and to the right.<br>
- Laozi (Tao Te Ching)
</div>
